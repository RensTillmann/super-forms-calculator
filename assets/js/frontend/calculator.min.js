(function($) { // Hide scope, no $ conflict
	...
	SUPER.init_calculator = function($changed_field, $form, $skip, $do_before, $do_after){
        ...
        // @since 1.6.0 - keep track of changed field and skip them within this loop
        ...
        if(typeof $changed_field === 'undefined') {
			...
			if(typeof $skip[$changed_field.attr('name')] === 'undefined' ){
				$skip[$changed_field.attr('name')] = {};
			}
			$skip[$changed_field.attr('name')][$changed_field.attr('name')] = $changed_field.attr('name');
        ...
        $.each($updated_calculator_fields, function( index, field ) {
            if(typeof $do_not_skip === 'undefined') {
            	if(typeof $skip[$changed_field.attr('name')][field.attr('name')] === 'undefined'){
            		$skip[$changed_field.attr('name')][field.attr('name')] = field.attr('name');
            		SUPER.after_field_change_blur_hook(field, $form, $skip);
        		}
            }else{
        		SUPER.after_field_change_blur_hook(field, $form, $skip);
        	}
