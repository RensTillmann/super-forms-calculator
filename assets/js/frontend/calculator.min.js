(function($) { // Hide scope, no $ conflict
	...
	SUPER.init_calculator = function($changed_field, $form, $skip, $do_before, $do_after){
        ...
        if($skip==false) var $do_not_skip = true;
	    ...
	    if( ( $hidden==true )  || ( ( $parent.css('display')=='none' ) && ( !$parent.hasClass('super-hidden') ) ) ) {
	        ...
	        if( !$element.length ) {
	        	...
	        	if($parent.hasClass('super-checkbox')){
                    ...
                    // @since 3.1.0 - compatibility with advanced tags like {field;2} etc.
	        	...
	        	// @since 3.1.0 - check for radio tags because it now can contain advanced tags like {field;2} etc.
