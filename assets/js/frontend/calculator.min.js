        ...
        if($field.hasClass('super-calculator')){
        	...
        	if( $math!='' ) {
			    ...
			    for (var $i = 0; $i < $array.length; $i++) {
			    	...
			    	console.log($this.parents('.super-form:eq(0)').find('.super-shortcode-field[name="'+$new_field+'"]'));
		...
		$calculator_fields.each(function(){
			...
			for (var $i = 0; $i < $array.length; $i++) {
				...
				if($found==true){
					...
					// If the math contains advanced tags do different replace method
					if($math.indexOf(';') >= 0){
						var $new_math = $new_math.replace('{','').replace('}','');
